...
```javascript
import dnannsumkbn2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnannsumkbn2@v0.0.9-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dnannsumkbn2/actions/workflows/test.yml/badge.svg?branch=v0.0.9
[test-url]: https://github.com/stdlib-js/blas-ext-base-dnannsumkbn2/actions/workflows/test.yml?query=branch:v0.0.9
