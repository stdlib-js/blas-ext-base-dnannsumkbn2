...
```javascript
import dnannsumkbn2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnannsumkbn2@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dnannsumkbn2/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-dnannsumkbn2/actions/workflows/test.yml?query=branch:v0.1.0
